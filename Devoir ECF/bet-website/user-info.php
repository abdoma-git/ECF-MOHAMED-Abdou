                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="dashboard-tab" data-bs-toggle="tab" href="dashboard.php" role="tab" aria-controls="dashboard" aria-selected="true">Dashboard</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="user-info-tab" data-bs-toggle="tab" href="user-info.php" role="tab" aria-controls="user-info" aria-selected="false">Informations Utilisateur</a>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active mt-3" id="user-info" role="tabpanel" aria-labelledby="user-info-tab">
