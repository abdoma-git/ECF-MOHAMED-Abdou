        ...
        <section class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-11">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title text-center">Liste des Joueurs</h1>
                            
                            <div class="tab-content" id="myTabContent">
                                <?php 
                                    //la table des matchs 
                                    $joueur = $dba->prepare(" SELECT * FROM `joueur` ");
                                    $joueur->execute();
                                    $tablejoueur = $joueur->fetchAll();
                                                ...
                                                foreach ($tablejoueur as $ligne){
                                                    print('
                                                        <tr>
                                                            ...
                                                            print('
                                                                <a data-bs-toggle="modal" href="deletejoueur.php?id='.$ligne["id"].'" data-bs-target="#confirmDeleteModal">
